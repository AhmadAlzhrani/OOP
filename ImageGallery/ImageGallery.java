...
public class lab20 extends Application {
	int i=1;
	ImageView pic1st;
	...
	public void start(Stage primaryStage) {
	    ...
	    String []names = {"previous","next","first","last"};
	...
	class ButtonHandler implements EventHandler<ActionEvent> {
	    ...
	    public void handle(ActionEvent e) {
	    	...
	    	else if("first".equals(id)) {pic1st.setImage(pics[0]);i=0;}
	    	
	    	else if("last".equals(id)) {pic1st.setImage(pics[pics.length-1]);i=pics.length-1;}
	    	else {
